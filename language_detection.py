...
# 2️⃣ Keep top 6 languages for better accuracy
...
# 4️⃣ Feature extraction using TF-IDF (char n-grams 2-4)
...
# 5️⃣ Split data into train/test (stratified)
...
# 9️⃣ Save best model and vectorizer
